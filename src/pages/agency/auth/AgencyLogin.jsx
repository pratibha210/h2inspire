...
import { agencyLogin } from "../../../api/api";
    ...
    await agencyLogin(userData)
      .then((res) => {
        ...
        if (res?.data.error == true) {
          ...
          navigate("/agency/welcome", { replace: true });
        }
      })
      .catch((err) => {
        setLoading(false);
    ...
    <>
      ...
      {pageLoading == true && (
        ...
        <span className="sub-login">
          ...
          <Link to={"/agency/register"}>Register</Link>
        </span>
        <span className="sub-login"> <Link to={'/agency/forgot-password'}>Forgot Password ?</Link></span>
      </Page>
    </>
  );
}
