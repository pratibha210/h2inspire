        ...
        {loading == true ? (
            ...
            <ul className="job-count">
                <li>
                    <div className="dash-box">
                        <div className="icon">
                            <img src="/src/assets/imgs/work.svg" />
                        </div>
                ...
                <li>
                    <div className="dash-box">
                        ...
                        <span className="count">{jobPostings.filter(e => e.status == "1").length}</span>
                    </div>
                </li>
                <li>
                    <div className="dash-box">
                        <div className="icon">
                            <img src="/src/assets/imgs/declined.svg" />
                        </div>
                        <h3>No of closed jobs</h3>
                        <span className="count">{jobPostings.filter(e => e.status == "2").length}</span>
                    </div>
                </li>
                <li>
                    <div className="dash-box">
                        ...
                        <span className="count">{jobPostings.filter(e => e.status == "3").length}</span>
                    </div>
                </li>
            </ul>
            <div className="recent-jobsection">
                ...
                <ul className="job-list job-list__single">
                    {jobPostings.length ?
                        jobPostings.filter(e => e.status == "1").map((e, i) => {
                            return (
                                <li key={i}>
                                    <div className="job-box">
                                        <div className="job-header">
                                            <div className="logo">
                                                <img src={e?.employer?.employer_image} alt="Employer image" />
                                            </div>
                                        ...
                                        <div className="job-content">
                                            <h2>{e.designation}</h2>
                                            {/* {e.job_description} */}
                                            <div dangerouslySetInnerHTML={createMarkup(e.job_description)} />
                                            <ul>
                                                <li>
                                                    <span>
                                                ...
                                                {e.hide_compensation && e.hide_compensation == true ? 
                                                <>
                                                    {null}
                                                </>
                                                :
                                                <li>
                                                    <span>
                                                     ...
                                                     {e.min_compensation} - {e.max_compensation} {e?.compensation_type.toUpperCase()}
                                                </li>
                                                }
                                                <li>
                                                    <span>
