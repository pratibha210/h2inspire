...
import infoLogo1 from "../../assets/imgs/infoLogo1.svg";
import infoLogo2 from "../../assets/imgs/infoLogo1.svg";
import infoLogo3 from "../../assets/imgs/infoLogo1.svg";
        ...
        <>
          <div className="recent-jobsection">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h3 className="dash-heading">All Working on Jobs</h3>
            </div>
                      ...
                      <div class="working-box">
                        ...
                        {e?.candidates?.length > 0 && (
                          <div class="box-bottom">
                            <div
                              class="view-candate collapsed"
                              data-bs-toggle="collapse"
                              data-bs-target={"#Demo" + i}
                            >
                              View My {e?.candidates?.length} Candidates{" "}
                              <span>
                                <img src={dropdownsamll} />
                              </span>
                            </div>
