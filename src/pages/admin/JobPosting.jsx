...
function JobPosting() {
  ...
  useEffect(() => {
    // console.log("employe >>>>>> ", searchParams.get("employe"));
  ...
  const getSubmitData = (event) => {
    ...
    const body = {
      employer: searchParams.get("employe"),
            ...
            <div className="form-box">
              ...
              <div className="row mb-3">
                <div className="col-md-3">
                  <div className="mb-3">
                    <label htmlFor="min_work_exp">
                      Min work exp.(In years)
                    </label>
                    <input
                      required
                      type="number"
                ...
                <div className="col-md-3">
                  <div className="mb-3">
                    <label htmlFor="max_work_exp">
                      Max work exp.(In years)
                    </label>
                    <input
                      required
                      type="number"
                ...
                <div className="col-md-3">
                  <div className="mb-3">
                    <label htmlFor="perk_and_benefits">Budget %</label>
                    <input
                      type="tel"
                      onKeyPress={(e) => {
                        if (!/[0-9 .]/.test(e.key)) {
                  ...
                  <div className="row" key={i}>
                    <div className="col-md-8 mb-3">
                      <input
                        ...
                        value={x}
                        onChange={(e) =>
                          handleScreeningQuestionInputChange(e, i)
                        }
                      />
                    </div>
