...
async function updateStatus(evt, status, id) {
  ...
  if(status == "true"){
    Swal.fire({
      title: "Do you want Approv this job?",
      showDenyButton: true,
      ...
      if (result.isConfirmed) {
        const resp = await adminJobApproval({"is_approved": status },id);
        if (resp?.data?.error == false) {
          Toast.fire({
...
async function editStatus(evt, status, id) {
  evt.preventDefault();
  console.log({ status, id });
  Swal.fire({
        ...
        <>
          <div className="recent-jobsection">
            <div className="d-flex justify-content-between align-items-center mb-4">
              <h3 className="dash-heading">All Jobs
              </h3>
              {/* <div className="short">
                Sort By:
                <select
                         ...
                         Approve 
                          ...
                          {/* <Link
                            ...
                            <p
                              ...
                              onClick={(evt) => editStatus(evt, "2", e._id)}
                            >
                              Close
                            </p>
                          </div>
